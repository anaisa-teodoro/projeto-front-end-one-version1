...
export const Dashboard = () => {
  // Contagem de usuários e locais
  const totalUsuarios = usuariosData.length;
  const totalLocais = usuariosData.reduce((acc, usuario) => acc + usuario.locations.length, 0);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-black text-white p-4 rounded-lg flex flex-col justify-between" style={{ width: '352px', height: '145px' }}>
          ...
          <div className="flex items-center justify-between mt-4">
            <span className="text-2xl font-bold text-[#D7FB00]">{totalUsuarios}</span>
        ...
        <div className="bg-black text-white p-4 rounded-lg flex flex-col justify-between" style={{ width: '352px', height: '145px' }}>
          ...
          <div className="flex items-center justify-between mt-4">
            <span className="text-2xl font-bold text-[#D7FB00]">{totalLocais}</span>
